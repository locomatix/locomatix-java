...
public class FenceKeyResponseHandler extends ResponseHandler<LocomatixResponse<String>> {
	...
	public LocomatixResponse<String> handle(HttpResponse response)
		...
		String fenceId = 
			jsonResponse.getJSONObject(ResponseKeys.RESULT).getString(ResponseKeys.FENCEID);
		LocomatixResponse<String> lxresponse = ResponseHandler.newLocomatixResponse();
		lxresponse.setResult(fenceId);

...
public class LocationHistoryResponseHandler extends 
	ResponseHandler<LocomatixResponse<ResultSet.Builder>> {

	@Override
	public LocomatixResponse<ResultSet.Builder> handle(
		...
		ResultSet.Builder builder = 
		  JsonParser.parseResultSet(result, Location.class, ResponseKeys.OBJECTS);

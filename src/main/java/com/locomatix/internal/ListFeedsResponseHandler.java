...
public class ListFeedsResponseHandler extends ResponseHandler<LocomatixResponse<ResultSet.Builder>> {
	...
	public LocomatixResponse<ResultSet.Builder> handle(HttpResponse response)
		...
		ResultSet.Builder builder = JsonParser.parseResultSet(result, Feed.class, ResponseKeys.FEEDS);
		
		LocomatixResponse<ResultSet.Builder> lxresponse = newLocomatixResponse();

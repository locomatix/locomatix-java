...
public class LXObjectKeyResponseHandler extends ResponseHandler<LocomatixResponse<Void>>{
	...
	public LocomatixResponse<Void> handle(HttpResponse response)
		...
		if (null == objectId || null == feedId)
      throw new LocomatixServiceException("Unexpected object response: " + result.toString());
